...
//     navigation.navigate('ForgotPassword'); // Adjust to your route name
//   };
...
export default function Login({ onLogin }) {
  ...
  const handleSignIn = () => {
    ...
    if (onLogin) {
      onLogin('dummy-token'); // triggers navigation in App.jsx
    }

    // Option 2: If RegisteredCars is directly registered in navigator
